...
better (NEED EVIDENCE) than fits of either the logistic or generalised
logistic model from the QFA R package
\citep{Addinall2011,qfa2016}. Competition model ranking of growth
estimates for repeats on P15 (see
...
slowest growers (and with rankings from independent spot tests (refs)
CHECK THIS). However, there is much disagreement in the rank of other
...
model which fit to individual cultures. The greater reliability of
...
genetic interactions. Although improved, uncertainty in estimates for
the slowest growers is still much higher than for the fastest meaning
that the power to infer genetic reactions is not dramatically
improved. (HIS3 has about half the variance for the competition model
...
concentration of nutrients in the agar so that the stationary phase is
reached before cultures start to merge.
...
accuracy than precision anyway). It would be informative to repeat P15
with \(C(0)\) at a measurable level. In any case, it is clear that the
