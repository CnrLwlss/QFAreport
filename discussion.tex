...
model may be required \citep{Kopelman1988,savageau1995}.


Estimates of the nutrient diffusion constant \(k_{n}\) were fairly
high such that nutrients diffused fairly readily between neighbours
and nutrients were nearly depleted when growth stopped. It may be that
nutrients are not well approximated as being evenly distributed
withing the spatial scales that modelling using a finer grid would
correct this. The distribution of nutrients at the end of growth could
be tested experimentally by inoculating new cultures at different
distances from mature cultures on the same plate.
