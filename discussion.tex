...
On average, the competition model fit internal cultures less closely
than the logistic model: objective function value was 0.194 vs 0.155
(Table~\ref{tab:P15_obj_fun}).

However, for the two fastest growing cultures in a 3x3 zone studied in
more detail, the competition model fit far more closely and logistic
model objective function values were particularly high
(Figure~\ref{fig:P15_zone_fit}). I am yet to determine whether this
trend carries across the plate. If it does the experiment will have
favoured the logistic model because slow growing cultures outnumber
fast growing cultures on the plate.

Why might the logistic model fit better to slow growing cultures? P15
used a low inoculum density so slow growing cultures were dominated by
noise. Whereas the competition model fit all cultures collectively,
the logistic model fit all cultures independently and had three
degrees of freedom rather than one to fit each culture. (three culture
level parameters vs one). (Noise from slow growing cultures will also
have affected competition model estimates for fast growing cultures
through plate level parameters and neighbour interactions.)

In most regions on the plate there is little competition.


noise dominated and more parameters

less competition for most zones

overall effect of noise dominated on comp collective fit


Slow growing cultures are dominated by noise and
outnumber fast growing cultures on the plate so if it does
(Figure~\ref{fig:comp_fit_plate}.




Nevertheless, in a 3x3 zone with larger than average differences in
culture growth rate, the competition model fits data more closely on
average, and fits much more closely for the two fast growing cultures
where logistic model objective function values are particularly high
(Figure~\ref{fig:P15_zone_fit}). I am yet to determine whether this
trend carries across the plate.
