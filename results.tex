...
\begin{Figure}
  \centering
  \includegraphics[width=\linewidth]{final/r_correlations}
  \captionof{figure}{\textbf{Correlation of r estimates between
    ...
    to logistic model r. The plot shows the correlation of r estimates
    between plates for both models. I only used data for cultures that
    were common between the two plates common and removed edge
    cultures. The Pearson correlation coefficient, \(\rho\), is shown in the
    legend. The line \(y=x\) is also plotted.}
