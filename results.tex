...
\begin{Figure}
  ...
  \captionof{figure}{Comp Model BC simulation using parameters from
    Imaginary Nieghbour guessing of P15. NOT TO GO HERE This method of
    guessing requires a b_{guess} value to be supplied to fix the faster
    growing neighbour. (I iterated through cell_ratiosI iterated through a range of b guesses
    supplied at the plate level; running a different script with a C_0
    guess, b_guess. It would probably have been better iterate through
    a list of b_{guess} values for each culture and choosing the
