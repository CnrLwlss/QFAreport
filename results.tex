...
\subsection{\thesubsection~Correlation or r estimates between models}
...
\begin{center}
  ...
  \begin{tabular}{l l l l l l}
    ...
    \hline
    Stripes   & 8.32\(\times\)10\(^{-3}\)   & 0.085      & 0.096       & 1.9  & 39.5\\
    Filled    & 6.17\(\times\)10\(^{-3}\)   & 0.116      & 0.183       & 4.8  & 27.9\\
    \hline
  \end{tabular}
  \label{tab:P15_best_fit_params}
\end{center}
