...
\begin{center}
  \captionof{table}{\textbf{Estimated parameter values for the best
      two competition model fits to P15.} Spearman's rank correlation
    coefficient for \(b\) estimates of the cultures in common,
    \(\rho_{S}\) = 0.787.}
  \begin{tabular}{l l l l l l}
    \hline
...
\begin{center}
  \captionof{table}{\textbf{Estimated parameter values for the best
    ...
    Ordered by objective function values (Obj.) where lower values are
    better. The column MAD \(b\) is the mean absolute deviation of
    growth constants \(b\) with those of the best fit (row one). Mean
    \(b\) for the best fit was 27.9.}
  \begin{tabular}{l l l l l l}
    \hline
...
(\ref{fig:comp_fit_fixed_plate_level}). Estimates are worse for slow
growing cultures which are more affected by noise.
