...
\begin{center}
  ...
  \begin{tabular}{l l l l l}
    \hline
    Fit     & \(C(0)\)                    & \(N_{I}(0)\) & \(N_{E}(0)\) & \(k\)\\
    \hline
    1st     & 9.13\(\times\)10\(^{-5}\)    & 0.0641      & 0.0895       & 6.67\\
    2nd     & 13.87\(\times\)10\(^{-5}\)   & 0.0618      & 0.0974       & 8.31\\
    \hline
  \end{tabular}
...
Spearman's rank correlation coefficient for the best 5 fits (0.922 - 0.996)
MAD in \(b\) estimate for the bets five fits was ( 13.30
b MAD for top for fits
I have discarded the 5th best fit as it fit NE0 < N0 and shows more disagreement.
