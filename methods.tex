...
images as a proxy for cell density. I use these cell density
estimates, which have arbitrary units, throughout my analysis.

To fit the competition model I make maximum likelihood estimates of
parameters using a normal model of measurement error.

To fit
the competition model, I take maximum likelihood estimates of
parameters using a normal model of measurement error. For constrained
minimisation I used the L-BFGS-B algorithm from SciPy's integrate
package. I determined stopping criteria so that parameters of
full-plate simulated data sets, with a small amount of simulated
