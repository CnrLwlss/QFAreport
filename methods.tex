...
using SciPy's odeint and made maximum likelihood estimates of
parameters using a normal model of measurement error and the L-BFGS-B
algorithm from SciPy's integrate package for the competition model (cf. Sections~\ref{sec:solving_comp} and \ref{sec:fitting_comp}).
