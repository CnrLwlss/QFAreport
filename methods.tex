...
libRoadRunner, solving time decreased from tenths to hundredths of a
second (10 times faster). libRoadRunner requires models to be written
in SBML so I wrote code using the libSBML Python API to automatically
generate SBML versions of the competition model for any size plate.
...
unevenly spaced timepoints takes \(\sim\)3 hours and fitting a full
