...
I discovered that sets of \(b\) parameters drawn from different normal
...
bigger range. I could also use the fitted parameters for this rather
than drawing from a normal distribution..
\\
