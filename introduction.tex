...
be the best approach. QFA data from edge cultures is noisy due to
reflections from plate edges. This is only partially corrected for by
Colonyzer \cite{Lawless2010} and as a result data from edge cultures
is usually discarded. \cite{Addinall2011} grow repeats of the same
culture in edge locations, rather than leaving them empty, because of
...
assay, so a modelling approach promises to be more powerful.
% Furthermore, modelling may help us to identify and
