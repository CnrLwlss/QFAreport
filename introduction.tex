...
hereinafter referred to as the competition model
...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
Unlike the logistic model (\ref{eq:logistic_model}),
equation~\ref{eq:competition_model} has no analytically solution and
must instead me solved numerically.
