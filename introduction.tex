...
fitness estimates, without requiring extra repeats. Furthermore,
modelling may identify and explain the source of
competition. Simulations of a successful model could also be used to
compare experimental designs, and predict ways to reduce
competition. Poisoning of cultures by a signal molecule such as
...
of interaction exists, it will be very difficult to fit a model, and
experimental methods might be the best approach.
