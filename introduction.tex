...
% The eukaryote \textit{S. cerevisae}, is particularly useful for as a
% model of other eukaryotes such as human cells.
...
% each division. Evolutionary pressure on growth rate and yield has
% produced rapidly dividing organisms with compact genomes
% \citep{dethlefsen2007performance}
% \citet{giovannoni2014implications}. Many genes have been conserved
% in other species over billions of years of evolution, which is, in
% part, what makes \textit{E. Coli} and \textit{S. cerevisiae} useful
% as model species. The eukaryote \textit{S. cerevisae}, is
% particularly useful for as a model of other eukaryotes such as human
% cells.  Growth rate is measurable and is often used to determine the
% fitness of microbial organisms.
% For unicellular organisms, growth rate is equal to cell
% cycle progression rate. Evolutionary pressure has led to rapidly
% dividing organisms with a compact genome of essential genes. These
% genes have been conserved in other species over billions of years of
% evolution. The eukaryote \textit{S. cerevisiae}, is particularly
% useful for the study of other eukaryotes such as humans. Much of the
% genomes of microbial species have been conserved in other species over
% billions of years of evolution \citep{OBrien2005inparanoid}, which is,
% in part, what makes \textit{E. Coli} and \textit{S.  cerevisiae}
% useful as model species.


% The bacterium \textit{Eschericia Coli} and yeast \textit{Saccharomyces
%   cerevisiae} are unicellular organisms studied as a model prokaryote
% and eukaryote respectively. Much of genomes of bacteria and yeasts
% have been conserved in other species over billions of years of
% evolution \citep{OBrien2005inparanoid}. Consequently, intensive study
% of a model organisms can reveal much about the biology of other
% species. \textit{S. cerevisiae} is particularly useful as a model of
% other eukaryotes such as human cells.
% % It can easily be grown in the lab and has a small compact genome
% % compared to higher-order eukaryotes.

% Bacteria and yeast grow in colonies. In favourable conditions, growth
% is exponential and this makes growth rate a major component of
% fitness; colonies of faster growing strains quickly come to dominate
% populations. At a certain point growth becomes limited and a
% stationary phase is reached.
% % For unicellular organisms, growth rate is equal to cell cycle
% % progression rate. Bacteria and yeast evolve under competing
% % pressures on rapid division and efficient use of nutrients
% % \citet{dethlefsen2007performance}.
...
\begin{Figure}
  ...
  \captionof{figure}{\textbf{4x5 section of a QFA plate.} Cropped from
    a 16x24 format solid agar plate inoculated with dilute
    \textit{S. cerevisiae} cultures. Image captured at \(\sim\)2.5d
    after inoculation and incubation at 27\(^{\circ}C\).}
...
\begin{Figure}
  ...
  \captionof{figure}{\textbf{QFA experiment designed to examine
    ...
    inoculated in the positions missing in A. Images courtesy of
    \textit{Eva Holstein} (personal communication)}
...
\textit{Lawless} proposed a model of nutrient dependent growth and
