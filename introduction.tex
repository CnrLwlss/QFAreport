...
Attempts have been made to correct for competition in other
studies. An experimental approach would be to randomise the locations
of cultures and run repeats of plates. This has the advantage of not
reacquiring explicit knowledge or modelling of the source of
competition but reduces the throughput of the experiment. (Another
possible source of competition is poisoning of cultures by a signal
molecule such as ethanol which is produced by yeast in the metabolism
of sugars by fermentation.)
