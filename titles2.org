...
* TODO Stripes Results [0/16]
 - [ ] I fit the stripes and filled plates (link images) with the competition model.
 - [ ] The experiment is designed to test for conpeitotn see methods for a description of the data
 - [ ] Data courtesty of Eva holstein. Can go in acknowledgements
 - [ ] I took a Spline and take 15 timpoints
   (as described in fitting seciton).
 - [ ] Used a different range of C(0)
 - [ ] I compared fits with the
