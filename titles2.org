...
* TODO p15 results
  ...
  - [ ] Comparison of ranking [0/5]
    - [ ] b rank is equivalent to r and MDR rank for the competitino model.
    - [ ] I therefore compare competitoin model rankings of b with
      both types of fitness estimate for the logistic model.
    - [ ] How do fitness rankings between competition model and logistic model comparePu
