...
* TODO COV 2
  - [ ]
    - [ ] makes sense for logistic COV to be higher if estimates for
      reapeats of the same deletion are split between the two groups
      in correlation plot.
    - [ ] Lower variance may be explained by the. Faster growing
      cultures are fit more precisely but less accurately.
    - [ ] Discussion
      - [ ] Validation of gap in distribution
      - [ ] Possible effect on genetic interaction scores
	- [ ]
