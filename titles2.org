...
* TODO Discussion [0/0]
** TODO Discuss results and place in context of other work [0/2]
 - [ ] P15
   ...
   - [ ] COV
     ...
     - [ ] Probably due to sharing of plate level parameters, but not
       necessarily modelling of competition
 ...
 - [ ] Stripes and Filled
   ...
   - [ ] Performance of competition model seems better. Need
     correlation plot for P15 to compare.

** TODO Future Work [0/0]
