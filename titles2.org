...
* TODO p15 results
  - [-] Describe how the plate was fit
  ...
  - [X] Describe and compare the fits
  ...
  - [ ] Treatment of boundary conditions (may leave out) [0/6]
    - [ ] I also fit the one initial nutrient parameter model to P15
      using the exact same method.
    - [ ] plot shows the fits to the top left corner of P15 for both
      - [ ] Fits appear very similar in quality.
      - [ ] But look at table
    - [ ] Error in cultures next to the edge was reduced with the two parameter model
    - [ ] Internal cultures were fit better overall with the
    - [ ] Interestingly fits of the edge cultures were actaully worse
      - [ ] These are dominated by noise
      - [ ] Must be fit in the competitin model
    - [ ] Model is working correctly and fitting the cultures collectivly
