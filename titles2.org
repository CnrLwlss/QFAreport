...
* TODO Describe P15 [0/11]
 - [ ] Plate 15 from a standard library
 - [ ] From Addinall et al 2011
 - [ ] Dilute cultures of ~100 cells - not detectablen
 - [ ] Deletions of genes relevant to telomere stability
 - [ ] HIS3 is neutral deletion 14 repeats
 - [ ] All other deletions have 6 repeats
 - [ ] HIS3 is grown in edge locations and results are discarded
 - [ ] cdc13-1 is a temperature conditional mutant
   - [ ] What does \textit{CDC13} do? - is a gene important for
     telomere stability
 - [ ] plate is incubated at 27 C where cdc13-1 starts to have loss of function
 - [ ] How many timepoints over what time? 10 over ~4 days
 - [ ] Why choose this plate - see presentation
   - [ ] Lots of replicates
   - [ ] Large variation in fitness of strains - hope to induce
     competition.
   - [ ] There is validation data for some of the strains from
