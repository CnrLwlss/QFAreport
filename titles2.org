...
* TODO Describe Stripes and Filled plates [0/10]
 - [ ] Experiment designed to detect competiton effects Eva Holstein
   (personal communications April 2016)
 - [ ] Grown on two plates
   - [ ] Stripes: Strains are inoculated in every other column
   - [ ] Filled: The same strains are inoculated in the same positions
 ...
 - [ ] More concentrated (~10000 of cells) - detectable
 - [ ] Inocculated from the same liquid cultures.
 - [ ] What are the deletions?
 - [ ] No repeats for most strains
 - [ ] Background mutation cdc13-1 and rad57
 - [ ] The left most column is all HIS3
 - [ ] Temperature 27C
 - [ ] How many timepoints over what time ~50 timepoints over ~4 days
