...
* TODO p15 results
  ...
  - [-] Correlation of r estimats [2/3]
    ...
    - [-] describe plot
      ...
      - [ ] First I will look at the correlation between estiamtes for
        each culture (black).
      - [-] There distribution is split into two distinct correlated
        groups.
	...
	- [ ] The groups only overlap for middle values of competitoin
          model \(r\)
      ...
      - [ ] Extreme Outliers
	- [ ] QFA R package has heuristic checks to correct for
	...
	- [ ] Outliers that were fit with r = 0 for the logistic model
          but higher values for the competiton model. Due to heuristic
          checks setting values to zero.
	- [ ] Two outliers that were fit with very high r but very low K
	...
	- [ ] Competition model fits all cultures collectively using
      ...
      - [ ] Now describe distribution on medians
	- [ ] Most median values fall inside the main group of cultures with lower logistic r
	- [ ] However there are several that have both high
          competitoin and logistic model r that fall inside the
          outlying group.
	- [ ] A significant number of r estimates fall between the two
          groups. This must mean that for many cultures repeats are
          split between the two black groups.
	- [ ] This significantly worsens the correlation of r ranks
          between models.
	- [ ] Spearman's rho measures the correlation between rank
	...
	- [ ] Between cultures Spearman's rho is 0.731; between
          medians for each deletion Spearman's rho is 0.497.
	- [ ] Spearman's rho is imporved when comparing competiton
