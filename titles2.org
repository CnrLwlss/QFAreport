...
* TODO Intro ammendments [0/9]
 - [ ] Correct statements about yeast genome and growth [0/5]
   - [ ] Orthologs Inparanoid O'Brien
   - [ ] Do not state as Beguling (compact cells more efficient) Doolittle
   - [ ] Streamlining theory Giovannoni
   - [ ] Deth 2007 - "Performance of the translational apparatus
     varies with the ecological strategies of bacteria"
   - [ ] life with 6000 genes (yeast genome)
   - [ ] Growth in colonies
 - [ ] Reference Fisher for genetic interaction
 ...
 - [ ] Plots of r and K dists for stripes and filled
 - [ ] Could mention quorum sensing when I menthion ethanol
 - [ ] Sharped Plate images
 - [ ] Could put arrows, boxes, numbers, or letters on stripes and
   filled rows
 - [ ] Decide whether I like having the Reo model in the introduction.
 - [ ] Change kn-k and C_{t_{0}}->C(0), etc. in all figures
