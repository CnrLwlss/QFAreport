...
* TODO p15 results
  ...
  - [ ] Correlation of r estimats [0/6]
    - [ ] Converted competition model parameters to r as in section
    - [ ] Took the median of \(r\) estiamtes for each deletion
      - [ ] Took median rather than mean to reduce the effect of
    ...
    - [ ] Plotted correlation of \(r\) for individual cultures (black)
    - [ ] and for the medians (red)
    - [ ] and calculated Spearman's rank correlation coefficient for
      both correlations.
    - [ ] describe plot
      - [ ] Plotted correlations between cultures (black) and between
      ...
      - [ ] There distribution is split into two distinct correlated
        groups.
	- [ ] This is due to a gap in distribution of logistic model
          at around r = 4.
	- [ ] In contrast there is no such gap in the distribution of
          competition model estimates.
      - [ ] For the main group there is a linear correlation with
        gradient close to one. However, logistic model estimates were
        hihger for almost all cultures in this group.
      - [ ] Competiton model r varies more steeply with logistic model
  ...
  - [ ] Comparison of ranking [0/5]
    ...
    - [ ] How do fitness rankings between competition model and logistic model compare
