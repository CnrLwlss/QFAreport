...
* TODO p15 results
  ...
  - [-] Comparison of ranking [4/10]
    ...
    - [-] Compare logistic ranks
      - [X] est1 and rad50 are the outliers in correlation plot.
      - [X] MDR corrects and agrees with competition model
      - [ ] Spearmans rho for competito model and MDR much better than
    - [ ] disagree on the position of the neutral deletion HIS 3for r.
    - [X] How do fitness rankings between competition model and logistic model comparePu
      ...
      - [X] 13 places between his3\Delta
    - [ ] The two outliers with very high logistic \(r\) in
      Figure(prev) where repeats of rad50delta and est1delta.
    - [ ] Order is corrected when MDR is calculated and matches the competition model.
    - [ ] disagree on the position of the neutral deletion HIS 3.
